...
const featuresByBudget: Record<string, string[]> = {
  tier1: [
    ...
    "custom_design", "ssl_security", "google_maps", "photo_gallery",
  ],
  tier2: [
    "responsive_design", "contact_form", "seo_basic", "social_links", "hosting_setup",
    "custom_design", "ssl_security", "google_maps", "photo_gallery",
    "blog", "authentication", "user_profiles", "email_notifications",
    "multilingual", "search_filtering",
  ],
  tier3: [
    "responsive_design", "contact_form", "seo_basic", "social_links", "hosting_setup",
    "custom_design", "ssl_security", "google_maps", "photo_gallery",
    "blog", "authentication", "user_profiles", "email_notifications",
    "multilingual", "search_filtering",
    "payments", "dashboard", "cms", "file_upload", "analytics",
    "api_integration", "chat", "role_management",
  ],
  tier4: [
    "responsive_design", "contact_form", "seo_basic", "social_links", "hosting_setup",
    "custom_design", "ssl_security", "google_maps", "photo_gallery",
    ...
    "payments", "dashboard", "cms", "file_upload", "analytics",
    "api_integration", "chat", "role_management",
    "booking_system", "inventory", "crm", "automation_workflows",
    "push_notifications", "custom_api", "realtime_sync",
  ],
  tier5: [
    "responsive_design", "contact_form", "seo_basic", "social_links", "hosting_setup",
    "custom_design", "ssl_security", "google_maps", "photo_gallery",
    ...
    "booking_system", "inventory", "crm", "automation_workflows",
    "push_notifications", "custom_api", "realtime_sync",
    "ai_features", "advanced_security", "scalable_architecture",
    "ci_cd", "load_balancing", "data_migration", "white_label", "dedicated_support",
  ],
};
